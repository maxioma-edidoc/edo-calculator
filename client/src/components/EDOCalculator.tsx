            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-700">
                  {isAlreadyOnEDO
                    ? 'Вы уже работаете с электронными документами. Убедитесь, что вам удобно и выгодно работать с вашим текущим провайдером.'
                    : `Каждый месяц вы теряете около ${results.monthlySavingsHours} часов на бумажных операциях. EDIDOC устраняет затраты на создание бумажных документов, делая обмен простым и быстрым — контрагент сразу же получает вашу накладную.`}
                </p>
              </div>
